...
// export const getLeadsContent = createAsyncThunk<GetLeadsResponse, void>('leads/getLeadsContent', async (thunkApi) => {
//   const response = await fetch('/api/users?page=2').then((res) => {
//     return res
//   })
//   const data: GetLeadsResponse = response
//   return data
// })
